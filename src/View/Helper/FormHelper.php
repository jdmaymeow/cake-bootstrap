...
class FormHelper extends Helper
{
    use OptionsAwareTrait;
         ...
         */
        protected $_widgets = [
            'button' => 'CakeBootstrap\View\Widget\ButtonWidget',
            'radio' => ['CakeBootstrap\View\Widget\RadioWidget', 'nestingLabel'],
            'select' => 'CakeBootstrap\View\Widget\SelectBoxWidget',
            'textarea' => 'CakeBootstrap\View\Widget\TextareaWidget',
            '_default' => 'CakeBootstrap\View\Widget\BasicWidget',
        ];
